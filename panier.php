                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="panier.php" class="active"><i class="fa fa-shopping-cart"></i></a></li>
                            <?php if(empty($_SESSION['mail'])){ ?>
                            <?php }else{ //nothing?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h2>Liste des documents du PANIER</h2>
                        <span>Découvrez le document que vous cherchez depuis toujours.</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section" id="product">
        <div class="container">
            ...
            <?php
                ...
                $requete = $connect->query("SELECT * FROM panier_$us;");
                //Prix total dans la variable $totalPrix
                $totalPrix = 0;
                if( $requete->rowCount() == 0){
                    echo "<h4 class='mx-auto'>⚠️ Votre panier est vide🛒 !</h4>";
                }else{
                    echo '<table class="mx-auto">';
                    echo '<tr>';
                            echo '<th><strong style="font-size: 20px">Titre:</strong> </th>';
                            echo '<th><strong style="font-size: 20px">Nom du document:</strong> </th>';
                            echo '<th><strong style="font-size: 20px">Prix: (en FCFA)</strong></th>';
                            echo '<th><strong style="font-size: 20px">Actions:</strong> </th>';
                    echo '</tr>';
                    while( $row = $requete->fetch() ){
                        ...
                        echo '<tr>';
                            ...
                            echo "<td>". $row['prix']. "</td>";
                            echo "<td><a href='delete.php?id=" .$row['id']. "'><button>Supprimer</button></a></td>";
                        echo '</tr>';
                    }
                    echo '</table>';
                    echo '<div class="total">';
                        echo '<h4>Total: ' .$totalPrix. ' FCFA</h4>';
                        echo '<div class="main-border-button mt-5"><a href="#">Acheter !</a></div>';
                    echo '</div>';
                }
            ?>
        </div>
